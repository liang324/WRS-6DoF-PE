...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'weights/yolov9c-seg.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/segment/yolov9-c-dseg.yaml', help='model.yaml path')
    parser.add_argument('--log_filename', type=str, default=ROOT / 'dataset/coco-ABB.yaml', help='dataset.yaml path')
