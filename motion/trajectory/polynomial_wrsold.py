...
class TrajPoly(object):
    ...
    def piecewise_interpolation(self, path, control_frequency=.005, time_interval=1.0):
        ...
        分段插值
        :param path: 配置的1维数组
        :param control_frequency: 程序将采样time_intervals/control_frequency个配置
        :param time_interval: 在相邻关节之间移动的时间
        :return: 插值后的配置、速度和加速度
