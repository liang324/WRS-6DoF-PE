...
class DualQuaternion(object):
    ...
    def __mul__(self, val):
        ...
        raise ValueError('Cannot multiply dual quaternion with objects of end_type {0}'.format(type(val)))
    ...
    def __add__(self, val):
        ...
        if not isinstance(val, DualQuaternion):
            raise ValueError('Cannot add dual quaternion with objects of end_type {0}'.format(type(val)))
