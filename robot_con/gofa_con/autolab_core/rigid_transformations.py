...
class RigidTransform(object):
    ...
    def __mul__(self, rigid_object):
        ...
        rigid_object : :obj:`RigidTransform` or :obj:`BagOfPoints`
            The rigid objects to multiply by this transform.

        Returns
        -------
        :obj:`RigidTransform` or :obj:`BagOfPoints`
            An objects of the same type as the input.
        ...
        raise ValueError('Cannot multiply rigid transform with objects of type %s' % (type(rigid_object)))
