...
class KinectBodyTracker:
	...
	def release_frame(self):
		...
		Parameters:
		k4abt_frame_t* body_frame_handle: Handle to a body frame objects to return to SDK.
	...
	def get_num_bodies(self):
		...
		Parameters:
		k4abt_frame_t* body_frame_handle: Handle to a body frame objects returned by k4abt_tracker_pop_result function.
