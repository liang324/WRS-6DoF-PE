    ...
    def __init__(self, collada, id, name, sourcebyid, primitives=None,
        ...
        """Create a geometry instance
          ...
          :param collada.Collada collada:
            The collada objects this geometry belongs to
          :param str id:
        ...
        """The :class:`collada.Collada` objects this geometry belongs to"""
...
class BoundGeometry(object):
    ...
    def __init__(self, geom, matrix, materialnodebysymbol):
        ...
        self.original = geom
        """The original :class:`collada.geometry.Geometry` objects this
        is bound to"""
