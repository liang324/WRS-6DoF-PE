...
class CImage(DaeObject):
    ...
    image objects or numpy arrays in both int and float format. We
    ...
    """PIL Image objects if PIL is available and the file is readable."""
...
class Surface(DaeObject):
    ...
    def __init__(self, id, img, format=None, xmlnode=None):
        ...
        self.image = img
        """:class:`collada.material.CImage` objects from the image library."""
...
class Map(DaeObject):
    ...
    for one of its properties, you'll find an objects of this class in the
    ...
    def __init__(self, sampler, texcoord, xmlnode=None):
        ...
        """:class:`collada.material.Sampler2D` objects to map"""
