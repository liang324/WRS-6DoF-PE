...
class SceneNode(DaeObject):
    ...
    def objects(self, tipo, matrix=None):
        ...
        :param str tipo:
          A string for the desired objects type. This can be one of 'geometry',
...
class Node(SceneNode):
    """Represents a node objects, which is a point on the scene graph, as defined in the collada <node> tag.
    ...
    def __init__(self, id, children=None, transforms=None, xmlnode=None):
        ...
        :param list children:
          ...
          objects that inherits from :class:`collada.scene.SceneNode`
        :param list transforms:
          A list of transformations effecting the node. This can
          contain any objects that inherits from :class:`collada.scene.Transform`
        :param xmlnode:
          When loaded, the xmlnode it comes from
...
class NodeNode(Node):
    ...
    def __init__(self, node, xmlnode=None):
        ...
        """
        self.node = node
        """An objects of type :class:`collada.scene.Node` representing the node to bind in the scene"""
...
class GeometryNode(SceneNode):
    ...
    def __init__(self, geometry, materials=None, xmlnode=None):
        ...
        """An objects of type :class:`collada.geometry.Geometry` representing the
...
class ControllerNode(SceneNode):
    ...
    def __init__(self, controller, materials, xmlnode=None):
        ...
        """ An objects of type :class:`collada.controller.Controller` representing
...
class MaterialNode(SceneNode):
    ...
    def __init__(self, symbol, target, inputs, xmlnode=None):
        ...
        :param collada.material.Material target:
          The material objects being bound to
        :param list inputs:
        ...
        """The symbol within a geometry this material should be bound to"""
        self.target = target
        """An objects of type :class:`collada.material.Material` representing the material objects being bound to"""
        self.inputs = inputs
        """A list of tuples of the form ``(semantic, input_semantic, set)`` mapping
          texcoords or other inputs to material input channels, e.g.
          ``('TEX0', 'TEXCOORD', '0')`` would map the effect parameter ``'TEX0'``
...
class CameraNode(SceneNode):
    ...
    def __init__(self, camera, xmlnode=None):
        ...
        """
        self.camera = camera
        """An objects of type :class:`collada.camera.Camera` representing the instantiated camera"""
        if xmlnode != None:
            self.xmlnode = xmlnode
...
class LightNode(SceneNode):
    ...
    def __init__(self, light, xmlnode=None):
        ...
        """
        self.light = light
        """An objects of type :class:`collada.light.Light` representing the instantiated light"""
        if xmlnode != None:
            self.xmlnode = xmlnode
...
def loadNode(collada, node, localscope):
    """Generic scene node loading from an xml `node` and a `collada` objects.
...
class Scene(DaeObject):
    """The root objects for a scene, as defined in a collada <scene> tag"""
